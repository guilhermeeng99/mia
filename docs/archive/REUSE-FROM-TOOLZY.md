...
> **Status**: Archived historical planning note. The active STT plan now lives in [`docs/specs/speech-to-text.md`](../specs/speech-to-text.md) and [`docs/ROADMAP.md`](../ROADMAP.md); this file is retained only for provenance from Toolzy.
